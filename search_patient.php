...
<div class="bg-main">
	...
	<section class="padsection">
		<div class="container_24">
			<form id="form2" action="search_patient.php?go=1" method="post">
				<div class="grid_24">
					<center><h1>Search Pateint</h1></center>
						<label><span class="text-form">Patient Name:</span><input type="int" name="name"></label>
			...
			?>
							...
							<?php
								...
								$sql="SELECT * FROM patient_entry WHERE name LIKE '%{$name}%'";
								$result=mysql_query($sql) or die('mysql error');

								while($row=mysql_fetch_array($result))
								{
							?>
							<a href="show_report.php?P_ID=<?php echo $row[0]?>">
								<div class="grid_8">
			...
			<?php
			  ...
			  echo  "<p>Please enter a search name</p>"; 
			  } 
			?>
			</form>	
			<div class="clear"></div>
