...
<div class="bg-main">
    ...
    <a class="btn">Send</a>
		...
		-->
			...
			<form id="form1" action="s_widal2.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_24">
					<label><span class="text-form">Reported On:</span><input type="date" value="<?php echo date('Y-m-d'); ?>" name="Reported_On"></label>
					<u><h4>ANTIGEN EMULSION</h4></u>
					<label><span class="text-form">Method:</span><input type="text" value="TUBE" name="Method"></label>
					<label><span class="text-form">S. Typhi 'O':</span><input type="text" name="o"></label>
					<label><span class="text-form">S. Typhi 'H':</span><input type="text" name="h"></label>
					<label><span class="text-form">S. Paratyphi 'AH':</span><input type="text" value="NILL" name="ah"></label>
					<label><span class="text-form">S. Paratyphi 'BH':</span><input type="text" value="NILL" name="bh"></label>
					<label><span class="text-form">Result:</span>
						<div class="wrapper"><input type="radio" name="reasult" value="0"><div class="text-form2 fleft">Negative</div></div>
						<div class="wrapper"><input type="radio" name="reasult" value="1"><div class="text-form2 fleft">Positive</div></div>
						<div class="wrapper"><input type="radio" name="reasult" value="2"><div class="text-form2 fleft">AMNESTIC REACTION</div></div>
					</label>
				</div>
