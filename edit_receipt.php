...
<div class="bg-main">
	...
	<section class="padsection">
		<div class="container_24">
			<center><h1>EDIT TEST</h1></center>
			<div class="clear"></div>
			<form id="form1" action="edit_receipt1.php" method="post">
				<div class="grid_5">
					<label><span class="text-form">OLD Test Name:</span></label>
					<label><span class="text-form">NEW Test Name:</span></label>
					<label><span class="text-form">NEW Test Charge:</span></label>
				</div>
				<div class="grid_19">
					<label>
						<select  name="old_test_name">
							<?php
								include('connect.php');
					...
					<label><input type="text" name="new_test_name"></label>
					<label><input type="text" name="new_test_charge"></label>
				</div>
				<center><div class="btns"><a class="btn" onClick="document.getElementById('form1').submit()">EDIT</a></div></center>
				<div class="clear"></div>
			</form>
			<div class="clear"></div>
			<div class="wrapper">
