...
<div class="bg-main">
    ...
    <a class="btn">Send</a>
		...
		-->
			...
			<form id="form1" action="blood_for_hiv2.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_24">
					<label><span class="text-form">Result:</span>
						...
						<div class="wrapper"><input type="radio" name="HIV" value="0"><div class="text-form2 fleft" checked>NEGATIVE</div></div>
					</label>
