...
if(isset($_GET['show']))
{
	...
	$sql2="SELECT * FROM stool_examination1 WHERE P_ID = '$row1[0]'";
...
<div class="bg-main"  style="font-size:18px;line-height: 1.4;">
	...
	<section class="padsection">
		<div class="container_24">
			...
			<hr>
			<!--main data-->
			<center><h3><u>EXAMINATION OF STOOL</u></h3></center>
			<div class="grid_9">
				<ul>
					<li><u>TEST</u></li>
					<br>
					<li><b><u>PHYSICAL EXAMINATION</u></b></li>
					<li>Colour</li>
					<li>Consistency</li>
					<li>Blood</li>
					<li>Mucus</li>
					<li>Pus</li>
					<li>Parasites</li>
					<li><b><u>CHEMICAL TEST</u></b></li>
					<li>Occult Blood(Benzidine Test)</li>
					<li>Reducing Sugar</li>
					<li>Reaction</li>
					<li><b><u>CONCENTRATION METHOD</u></b></li>
					<li>Ova</li>
					<li>Cysts</li>
					<li><b><u>MICROSCOPIC EXAMINATION / HPF</u></b></li>
					<li>Trophozoites</li>
					<li>Ova</li>
					<li>Cysts.</li>
					<li>Pus Cells / hpf</li>
					<li>RBC</li>
					<li>Macrophage Cells</li>
					<li>Epithelial Cells</li>
					<li>Vegetable Cells</li>
					<li>Starch</li>
					<li>Bacteria</li>
					<li>Neutral Fat</li>
					<li>Fatty Acid Crystal</li>
					<li>Fat Globules</li>
					<li>Hanging Drop Preparation</li>
			...
			<div class="grid_14" style="text-transform: uppercase;">
				<ul>
					...
					<li><?php if($row2[3]==0){echo 'ABSENT';}else{echo '<b><u>PRESENT</u></b>';}?></li>
					<li><?php if($row2[4]==0){echo 'ABSENT';}else{echo '<b><u>PRESENT</u></b>';}?></li>
					<li><?php if($row2[5]==0){echo 'ABSENT';}else{echo '<b><u>PRESENT</u></b>';}?></li>
					<li><?php if($row2[6]==0){echo 'ABSENT';}else{echo '<b><u>PRESENT</u></b>';}?></li>
					<li><br></li>
					<li><?php if($row2[7]==0){echo 'ABSENT';}else{echo '<b><u>PRESENT</u></b>';}?></li>
					<li><?php if($row2[8]==0){echo 'ABSENT';}else{echo '<b><u>PRESENT</u></b>';}?></li>
					...
					<li><?php echo $row2[14];?></li>
					<li><?php echo $row2[15];?></li>
					<li><?php echo $row2[16];?></li>
					<li><?php echo $row2[17];?></li>
					<li><?php echo $row2[18];?></li>
					<li><?php if($row2[19]==0){echo 'ABSENT';}else{echo '<b><u>PRESENT</u></b>';}?></li>
					<li><?php if($row2[20]==0){echo 'ABSENT';}else{echo '<b><u>PRESENT</u></b>';}?></li>
					<li><?php echo $row2[21];?></li>
					<li><?php echo $row2[22];?></li>
					<li><?php echo $row2[23];?></li>
					<li><?php echo $row2[24];?></li>
					<li><?php if($row2[25]==0){echo 'DARTING MOTILITY OF VIBRIO CHOLERAE: ABSENT';}else{echo '<b><u>DARTING MOTILITY OF VIBRIO CHOLERAE: PRESENT</u></b>';}?></li>
