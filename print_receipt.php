...
<div class="bg-main">
	...
	<section class="padsection">
		<div class="container_24">
			<form id="form1" action="print_receipt1.php" method="post">
				<div class="grid_24">
					<center><h1>Receipt Printing</h1></center>
						<label><span class="text-form">Patient No.:</span><input type="text" name="patient_no"></label>
						<label><span class="text-form">Patient Date:</span><input type="date" name="date" value="<?php echo date('Y-m-d'); ?>"></label>
						<label><span class="text-form">Test Name:</span>
						...
						<div class="btns"><a class="btn" onClick="document.getElementById('form1').submit()">GO</a></div>
				</div>
			</form>
			<div class="clear"></div>
			<div class="wrapper">
