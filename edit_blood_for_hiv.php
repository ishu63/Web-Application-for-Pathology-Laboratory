...
$sql1="SELECT * FROM blood_for_hiv WHERE P_ID = '$row[0]'";
...
<div class="bg-main">
	...
	<section class="padsection">
		<div class="container_24">
			<center><h1>EXAMINATION OF BLOOD FOR HIV</h1></center>
			<form id="form2">
				<div class="grid_8">
			...
			<form id="form1" action="edit_blood_for_hiv1.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_24">
					<?php
						$sql1="SELECT * FROM blood_for_hiv WHERE P_ID = '$row[0]'";
						$result1=mysql_query($sql1) or die('mysql error');
					...
					<label><span class="text-form">Result:</span>
						<div class="wrapper"><input type="radio" name="HIV" value="1" <?php if($row1[1]==1){echo "checked";}?>><div class="text-form2 fleft">POSITIVE</div></div>
						<div class="wrapper"><input type="radio" name="HIV" value="0" <?php if($row1[1]==0){echo "checked";}?>><div class="text-form2 fleft">NEGATIVE</div></div>
					</label>
					<label><span class="text-form">Method:</span><input type="text" value="TRI DOT"></label>
					<label><span class="text-form">Remarks:</span><input type="text" value="THIS IS ONLY A SCREENING TEST"></label>
					<label><span class="text-form">Advice:</span><input type="text" value="WESTERN BLOT METHOD"></label>
				</div>
