...
$sql1="SELECT * FROM urin_pragnancy WHERE P_ID = '$row[0]'";
...
<div class="bg-main">
    ...
    <a class="btn">Send</a>
		...
		-->
			<center><h1>Urin For Pregnancy Test</h1></center>
			<form id="form2">
				<div class="grid_8">
			...
			<form id="form1" action="edit_urin_pragnancy1.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_24">
					<?php
						$sql1="SELECT * FROM urin_pragnancy WHERE P_ID = '$row[0]'";
						$result1=mysql_query($sql1) or die('mysql error');
					...
					<label><span class="text-form">Sample:</span>
						<div class="wrapper"><input type="radio" name="sample" value="0" <?php if($row1[1]==0){echo "checked";}?>><div class="text-form2 fleft">MORNING</div></div>
						<div class="wrapper"><input type="radio" name="sample" value="1" <?php if($row1[1]==1){echo "checked";}?>><div class="text-form2 fleft">RANDOM</div></div>
					</label>
					<u><h5>Determination Of HCG in Urine</h5></u>
					<label><span class="text-form">Result:</span>
						<div class="wrapper pad-form"><input type="radio" name="result" value="0" <?php if($row1[2]==0){echo "checked";}?>><div class="text-form2 fleft">Negative</div></div>
						<div class="wrapper"><input type="radio" name="result" value="1" <?php if($row1[2]==1){echo "checked";}?>><div class="text-form2 fleft">Positive</div></div>
					</label>
					<label><span class="text-form">Method:</span>
						<div class="wrapper"><input type="radio" name="method" value="0" <?php if($row1[3]==0){echo "checked";}?>><div class="text-form2 fleft">ONE STEP CHROMATOGRAPHIC ASSAY</div></div>
						<div class="wrapper"><input type="radio" name="method" value="1" <?php if($row1[3]==1){echo "checked";}?>><div class="text-form2 fleft">ELISA</div></div>
					</label>
				</div>
