...
if(isset($_GET['show']))
{
	...
	$sql2="SELECT * FROM exam_urin WHERE P_ID = '$row1[0]'";
...
<div class="bg-main"  style="font-size:18px;line-height: 1.4;">
	...
	<section class="padsection">
		<div class="container_24">
			...
			<hr>
			<!--main data-->
			<center><h3><u>EXAMINATION OF URINE</u></h3></center>
			<div class="grid_9">
				<ul>
					<li><u>TEST</u></li>
					<br>
					...
					<li>Reaction</li>
					<li><b><u>CHEMICAL EXAMINATION</u></b></li>
					<li>Albumin</li>
					<li>Sugar</li>
					<li>Acetone</li>
					<li>Bile Salts</li>
					<li>Bile Pigments</li>
					<li><b><u>MICROSCOPIC EXAMINATION</u></b></li>
					<li>Pus Cells / hpf</li>
					<li>RBC / hpf</li>
					<li>Epithelial Cells / hpf</li>
					<li>Crystals / hpf</li>
					<li>Amorphous Phosphate</li>
					<li>Cast</li>
					<li>Bacteria</li>
					<li>Mucus</li>
					<li>Yeast</li>
			...
			<div class="grid_8" style="text-transform: uppercase;">
				<ul>
					<li><u>RESULT</u></li>
					<br>
					<li><?php if($row2[1]==0){echo 'RANDOM';}else{echo 'MORNING';}?></li>
					<li><br></li>
