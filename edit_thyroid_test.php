...
$sql1="SELECT * FROM thyroid_test WHERE P_ID = '$row[0]'";
...
<div class="bg-main">
	...
	<section class="padsection">
		<div class="container_24">
			<center><h1>Thyroid Function Test</h1></center>
			<form id="form2">
				<div class="grid_8">
			...
			<div class="clear"></div>
			<hr><hr><hr>
			<form id="form1" action="edit_thyroid_test1.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_12">
					<?php
						$sql1="SELECT * FROM thyroid_test WHERE P_ID = '$row[0]'";
						$result1=mysql_query($sql1) or die('mysql error');
					...
					?>
					<label><span class="text-form">Total Triiodothyronine - T3:</span></label>
					<label><span class="text-form"></span></label>
					<label><span class="text-form">Total Thyroxine - T4:</span></label>
					<label><span class="text-form">Thyroid Sti. Hormone - TSH:</span></label>
					<label><span class="text-form">Free Triiodothyronine - FT3:</span></label>
					<label><span class="text-form">Free Thyroxine - FT4:</span></label>
					<label><span class="text-form">ParaThyroid Hormone - PTH:</span></label>
				</div>
				<div class="grid_12">
					<label><span class="text-form"></span>
					<select name="t3lg">
						<option value="<" <?php if($row1[1]=="<"){echo "selected";}?>>  <  </option>
						<option value=">" <?php if($row1[1]==">"){echo "selected";}?>>  >  </option>
						<option value="=" <?php if($row1[1]=="="){echo "selected";}?>>  =  </option>
					</select>
					</label>
					<label><span class="text-form"></span><input type="text" name="T3" value="<?php echo $row1[2];?>"></label>
					<label><span class="text-form"></span><input type="text" name="T4" value="<?php echo $row1[3];?>"></label>
					<label><span class="text-form"></span><input type="text" name="TSH" value="<?php echo $row1[4];?>"></label>
					<label><span class="text-form"></span><input type="text" name="FT3" value="<?php echo $row1[5];?>"></label>
					<label><span class="text-form"></span><input type="text" name="FT4" value="<?php echo $row1[6];?>"></label>
					<label><span class="text-form"></span><input type="text" name="PTH" value="<?php echo $row1[7];?>"></label>
				</div>
				<div class="grid_12">
				</div>
