...
<div class="bg-main">
    ...
    <a class="btn">Send</a>
		...
		-->
			...
			<form id="form1" action="urin_pragnancy2.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_24">
					<label><span class="text-form">Sample:</span>
						<div class="wrapper"><input type="radio" name="sample" value="0"><div class="text-form2 fleft">MORNING</div></div>
						<div class="wrapper"><input type="radio" name="sample" value="1"><div class="text-form2 fleft">RANDOM</div></div>
					</label>
					...
					<label><span class="text-form">Method:</span>
						<div class="wrapper"><input type="radio" name="method" value="0"><div class="text-form2 fleft">ONE STEP CHROMATOGRAPHIC ASSAY</div></div>
						<div class="wrapper"><input type="radio" name="method" value="1"><div class="text-form2 fleft">ELISA</div></div>
					</label>
				</div>
