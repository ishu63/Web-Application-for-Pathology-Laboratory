...
<div class="bg-main">
	...
	<section class="padsection">
		<div class="container_24">
			<form id="form2" action="trail1.php" method="post">
				<div class="grid_12">
					<center><h1>Patient Form</h1></center>
						...
						<label><span class="text-form">Doctor's Name:</span><input type="text" name="doctor_name" required></label>
						...
						<label><span class="text-form fleft">Age:</span><input type="int" name="age" required></label>
						<div class="btns"><a class="btn" onClick="document.getElementById('form2').submit()">Save</a></div>
						<input class="btn print success" id="btnPrint" type="button" value="Print Me!" onclick="document.getElementById('form2').submit()">
				</div>
			</form>
			<div class="clear"></div>
			<div class="wrapper">
