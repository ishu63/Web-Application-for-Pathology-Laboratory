...
if(isset($_GET['show']))
{
	...
	$sql2="SELECT * FROM bloood_glucose WHERE P_ID = '$row1[0]'";
...
<div class="bg-main"  style="font-size:18px;line-height: 1.4;">
	...
	<section class="padsection">
		<div class="container_24">
			...
			<hr>
			<!--main data-->
			<center><h3><u>BLOOD GLUCOSE TEST</u></h3></center>
			<div class="grid_9">
				<ul>
					<li><u>TEST</u></li>
					<br>
					<li>Fasting Blood Sugar</li>
					<li>Fasting Urine Sugar</li>
					<li>Fasting Urine Acetone</li>
					<li>Post Prandial Blood Sugar</li>
					<li>Post Prandial Urine Sugar</li>
					<li>Post Prandial Urine Acetone</li>
				</ul>
			</div>
			<div class="grid_1">
				<ul>
			...
			<div class="grid_8" style="text-transform: uppercase;">
				<ul>
					<li><u>RESULT</u></li>
					<br>
					<li><?php if($row2[1]<80 OR $row2[1]>100){echo '<b><u>';echo $row2[1];echo '</u></b>';}else{echo $row2[1];}?></li>
					<li><?php echo $row2[2];?></li>
					<li><?php echo $row2[3];?></li>
					<li><?php if($row2[4]<100 OR $row2[4]>140){echo '<b><u>';echo $row2[4];echo '</u></b>';}else{echo $row2[4];}?></li>
