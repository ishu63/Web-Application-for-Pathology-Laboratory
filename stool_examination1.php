...
<div class="bg-main">
    ...
    <a class="btn">Send</a>
		...
		-->
			...
			<form  id="form1" action="stool_examination2.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_12">
					...
					<label><span class="text-form">Blood:</span>
						<div class="wrapper pad-form"><input type="radio" name="blood" value="0" checked ><div class="text-form2 fleft">ABSENT</div></div>
						<div class="wrapper"><input type="radio" name="blood" value="1"><div class="text-form2 fleft">PRESENT</div></div>
					</label>
					<label><span class="text-form">Mucus:</span>
						<div class="wrapper pad-form"><input type="radio" name="mucus" value="0" checked ><div class="text-form2 fleft">ABSENT</div></div>
						<div class="wrapper"><input type="radio" name="mucus" value="1"><div class="text-form2 fleft">PRESENT</div></div>
					</label>
					<label><span class="text-form">Pus:</span>
						<div class="wrapper pad-form"><input type="radio" name="pus" value="0" checked ><div class="text-form2 fleft">ABSENT</div></div>
						<div class="wrapper"><input type="radio" name="pus" value="1"><div class="text-form2 fleft">PRESENT</div></div>
					</label>
					<label><span class="text-form">Parasites:</span>
						<div class="wrapper pad-form"><input type="radio" name="parasites" value="0" checked ><div class="text-form2 fleft">ABSENT</div></div>
						<div class="wrapper"><input type="radio" name="parasites" value="1"><div class="text-form2 fleft">PRESENT</div></div>
					</label>
					<u><h4>CHEMICAL TEST</h4></u>
					<label><span class="text-form">Occult Blood Benzidine Test:</span>
						<div class="wrapper pad-form"><input type="radio" name="blood_benzidine" value="0" checked ><div class="text-form2 fleft">ABSENT</div></div>
						<div class="wrapper"><input type="radio" name="blood_benzidine" value="1"><div class="text-form2 fleft">PRESENT</div></div>
					</label>
					<label><span class="text-form">Reducing Sugar:</span>
						<div class="wrapper pad-form"><input type="radio" name="reducinng_sugar" value="0" checked ><div class="text-form2 fleft">ABSENT</div></div>
						<div class="wrapper"><input type="radio" name="reducinng_sugar" value="1"><div class="text-form2 fleft">PRESENT</div></div>
					</label>
					<label><span class="text-form">Reaction:</span>
						<div class="wrapper pad-form"><input type="radio" name="reaction" value="ACIDIC" checked ><div class="text-form2 fleft">ACIDIC</div></div>
				...
				<div class="grid_12">
					...
					<label><span class="text-form">Ova:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="NILL" name="ova"></label>
					<label><span class="text-form">Cysts:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="NILL" name="crysts"></label>
					<u><h4>MICROSCOPIC EXAMINATION / HPF</h4></u>
					<label><span class="text-form">Trophozoites:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="ABSENT" name="Trophozoites"></label>
					<label><span class="text-form">Ova:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="ABSENT" name="Ova1"></label>
					<label><span class="text-form">Cysts:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="ABSENT" name="Cysts"></label>
					<label><span class="text-form">Pus Cells/hpf:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="ABSENT" name="hpf"></label>
					<label><span class="text-form">RBC:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="ABSENT" name="RBC"></label>
					<label><span class="text-form">Macrophage Cells:&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="ABSENT" name="Macrophage"></label>
					<label><span class="text-form">Epithelial Cells:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="ABSENT" name="Epithelial"></label>
					<label><span class="text-form">Vegetable Cells:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<div class="wrapper pad-form"><input type="radio" name="vegetable_cells" value="0" checked ><div class="text-form2 fleft">ABSENT</div></div>
						<div class="wrapper"><input type="radio" name="vegetable_cells" value="1"><div class="text-form2 fleft">PRESENT</div></div>
					</label>
					<label><span class="text-form">Starch:</span>
						<div class="wrapper pad-form"><input type="radio" name="Starch" value="0" checked ><div class="text-form2 fleft">ABSENT</div></div>
						<div class="wrapper"><input type="radio" name="Starch" value="1"><div class="text-form2 fleft">PRESENT</div></div>
					</label>
					<label><span class="text-form">Bacteria:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="ABSENT" name="Bacteria"></label>
					<label><span class="text-form">Neutral Fat:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="ABSENT" name="Neutral_Fat"></label>
					<label><span class="text-form">Fatty Acid Crystal:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="ABSENT" name="Fatty_Acid_Crystal"></label>
					<label><span class="text-form">Fat Globules:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" value="ABSENT" name="Fat_Globules"></label> 
					<label><span class="text-form">Hanging Drop Preparation:</span>
						<div class="wrapper pad-form"><input type="radio" name="Preparation" value="0" checked ><div class="text-form2 fleft">ABSENT</div></div>
						<div class="wrapper"><input type="radio" name="Preparation" value="1"><div class="text-form2 fleft">PRESENT</div></div>
					</label>
					<label><span class="text-form">Food Particles:</span><input type="text" value="ABSENT" name="Food_Particles"></label>
				</div>
