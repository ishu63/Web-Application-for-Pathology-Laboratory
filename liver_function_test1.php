...
<div class="bg-main">
    ...
    <a class="btn">Send</a>
		...
		-->
			...
			<form id="form1"  action="liver_function_test2.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_12">
				...
				<div class="grid_12">
					...
					<label><span class="text-form">Patient's P.T.:</span><input type="text" name="Patient_PT"></label>
					<label><span class="text-form">Control's P.T.:</span><input type="text" name="Control_PT"></label>
					<label><span class="text-form">ISI:</span><input type="text" name="ISI"></label>
					<label><span class="text-form">P. Index:</span><input type="text" name="Index"></label>
					<label><span class="text-form">P. Ratio:</span><input type="text" name="Ratio"></label>
					<label><span class="text-form">INR:</span><input type="text" name="INR"></label>
