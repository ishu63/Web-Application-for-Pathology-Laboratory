...
if(isset($_GET['show']))
{
	...
	$sql2="SELECT * FROM s_widal WHERE P_ID = '$row1[0]'";
...
<div class="bg-main"  style="font-size:18px;line-height: 1.4;">
	...
	<section class="padsection">
		<div class="container_24">
			...
			<hr>
			<!--main data-->
			<center><h3><u>S. WIDAL TEST</u></h3></center>
			<div class="grid_9">
				<ul>
					<li><u>TEST</u></li>
					<br>
					<li>Reported On</li>
					<li><b><u>ANTIGEN EMULSION</u></b></li>
					<li>Method</li>
					<li>S. Typhi 'O'</li>
					<li>S. Typhi 'H'</li>
					<li>S. Paratyphi 'AH'</li>
					<li>S. Paratyphi 'BH'</li>
					<li>Result</li>
					<li>Advise</li>
				</ul>
			</div>
			...
			<div class="grid_14" style="text-transform: uppercase;">
				<ul>
					...
					<li><?php echo $row2[3];?></li>
					<li><?php echo $row2[4];?></li>
					<li><?php echo $row2[5];?></li>
					<li><?php if($row2[6]=='0'){echo 'NEGATIVE';}elseif($row2[6]=='1'){echo '<b>POSITIVE</b>';}else{echo '<b><u>AMNESTIC REACTION</u></b>';}?></li>
					<li><?php if($row2[6]=='2'){echo '<b><u>IF NECESSORY PLEASE REPEAT THE TEST AFTER FEW DAYS</u></b>';}else{echo 'NILL';}?></li>
				</ul>
			</div>
			<div class="clear"></div><br><br>
			<div class="grid_24">
				<ul>
					<li><u>INTERPRETATION :</u></li>
				</ul>
			</div>
			<div class="grid_1">
				<ul>
			...
			<div class="grid_20">
				<ul>
					<li>'H' and 'O' agglutination appears in the serum after five to seven days.</li>
					<li>'O' agglutinins appears before 'H' & is usually higher at first. Later on 'H' is higher.</li>
					<li>Usually criteria for diagnosis is both 'O' and 'H'.</li>
					<li>Positive reaction could occur on account of typhoid vaccination or previous typhoid infection.</li>
					<li>Non specific febrile disease may cause this titre to increase. (anamnestic reaction).</li>
					<li>Rising titre is a better parameter for proper evaluation.</li>
					<li>Early treatment with specific drug may cause titre to remain negative.</li>
					<li>Increased in 'O' titre may reflect infection with any salonella organisms.</li>
					<li>Urine or stool culture is preferable when illness is of more than four weeks duration.</li>
					<li>Result of slide technique should always be confirmed by Tube technique.</li>
				</ul>
			</div>
			<div class="grid_4">
				<ul>
