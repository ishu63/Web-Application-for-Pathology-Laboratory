	...
	<section class="padsection">
		<div class="container_24">
			...
			<div class="grid_24">
				<table align="center" >
					<tr>
						<th width="73"><center>Test ID</center></th>
						<th width="300"><center>Test Name</center></th>
						<th width="500"><center>Test Charge</center></th>
					</tr>
					<?php
						$rr=0;
						include('connect.php');
					...
					?>
					<tr>
						<td height="30" align="center"><?php echo $row['test_id'];?></td>
						<td align="center"><?php echo $row['test_name'];?></td>
						<td align="center"><?php echo $row['test_charge'];?></td>
					</tr>
					<?php } ?>
				</table>
			</div>
			...
			<center>
				<div class="btns">
					<a class="btn" onClick="window.location='insert_receipt.html';">ADD</a>
					<a class="btn" onClick="window.location='edit_receipt.php';">EDIT</a>
					<a class="btn" onClick="window.location='delete_receipt.php';">DELETE</a>
				</div>
			</center>
			<div class="clear"></div>
			<br>
			<center>
				<div class="btns">
					<a class="btn" onClick="window.location='print_receipt.php';">PRINT</a>
				</div>
			</center>
			<div class="clear"></div>
			<div class="wrapper">
