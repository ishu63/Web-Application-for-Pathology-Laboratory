...
$sql1="SELECT * FROM pre_operative_profile WHERE P_ID = '$row[0]'";
...
<div class="bg-main">
    ...
    <a class="btn">Send</a>
		...
		-->
			...
			<form id="form2" action="edit_pre_operative_profile1.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_12">
					<?php
						$sql1="SELECT * FROM pre_operative_profile WHERE P_ID = '$row[0]'";
						$result1=mysql_query($sql1) or die('mysql error');
					...
					<label><span class="text-form">RBS:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" name="rbs" value="<?php echo $row1[3];?>"></label>
					<label><span class="text-form">Serum Creatinine:</span><input type="text" name="Creatinine" value="<?php echo $row1[4];?>"></label>
					<label><span class="text-form">SGPT:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" name="SGPT" value="<?php echo $row1[5];?>"></label>
					<label><span class="text-form">HBsAg:</span>
						<div class="wrapper"><input type="radio" name="hb" value="1" <?php if($row1[6]==1){echo "checked";}?>><div class="text-form2 fleft">POSITIVE</div></div>
						<div class="wrapper"><input type="radio" name="hb" value="0" <?php if($row1[6]==0){echo "checked";}?>><div class="text-form2 fleft">NEGATIVE</div></div>
					</label>
					<label><span class="text-form">HIV:</span></label>
						<div class="wrapper"><input type="radio" name="hiv" value="1" <?php if($row1[7]==1){echo "checked";}?>><div class="text-form2 fleft">POSITIVE</div></div>
						<div class="wrapper"><input type="radio" name="hiv" value="0" <?php if($row1[7]==0){echo "checked";}?>><div class="text-form2 fleft">NEGATIVE</div></div>
					</label>
				</div>
				<div class="grid_12">
					<u><h4>Prothrombin Time</h4></u>
					<label><span class="text-form">pateint Time:</span><input type="time" name="pateint" value="<?php echo $row1[8];?>"></label>
					<label><span class="text-form">Control Time:</span><input type="time" name="Control" value="<?php echo $row1[9];?>"></label>
					<label><span class="text-form">P.T. Index:</span><input type="text" name="Index" value="<?php echo $row1[10];?>"></label>
					<label><span class="text-form">P.T. Ratio:</span><input type="text" name="Ratio" value="<?php echo $row1[11];?>"></label>
					<label><span class="text-form">ISF Value:</span><input type="text" name="Value" value="<?php echo $row1[12];?>"></label>
					<label><span class="text-form">P.T. INR:</span><input type="text" name="INR" value="<?php echo $row1[13];?>"></label>
				</div>
