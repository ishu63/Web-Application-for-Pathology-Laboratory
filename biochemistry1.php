...
<div class="bg-main">
    ...
    <a class="btn">Send</a>
		...
		-->
			...
			<form id="form1" action="biochemistry2.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_8">
					<u><h4>RENAL FUNCTION</h4></u>
					<label><span class="text-form">Blood Urea:</span><input type="text" name="Blood_Urea"></label>
					<label><span class="text-form">Blood Urea <br>Nitrogen-BUN:</span><input type="text" name="Nitrogen_BUN"></label>
					<label><span class="text-form">Serum Creatinine:</span><input type="text" name="Creatinine"></label>
					<label><span class="text-form">Serum Uric Acid:</span><input type="text" name="Uric_Acid"></label>
					<label><span class="text-form">Serum Calcium:</span><input type="text" name="Calcium"></label>
					<label><span class="text-form">Serum Ionised <br>Free Calcium:</span><input type="text" name="Ionised"></label>
					<u><h4>SERUM ELECTROLYTE</h4></u>
					<label><span class="text-form">Serum Sodium(Na):</span><input type="text" name="Na"></label>
					<label><span class="text-form">Serum <br>Potassium(K):</span><input type="text" name="K"></label>
					<label><span class="text-form">Serum Chloride(Cl):</span><input type="text" name="Cl"></label>
					<label><span class="text-form">Serum Phosphorus:</span><input type="text" name="Phosphorus"></label>
					<u><h4>SERUM PROTEIN</h4></u>
					<label><span class="text-form">Total:</span><input type="text" name="Total"></label>
					<label><span class="text-form">Albumin:</span><input type="text" name="Albumin"></label>
					<label><span class="text-form">Globulin:</span><input type="text" name="Globulin"></label>
					<label><span class="text-form">A/G Ratio:</span><input type="text" name="AG_Ratio"></label>
				</div>
				<div class="grid_8">
					<u><h4>LIVER FUNCTION</h4></u>
					<label><span class="text-form">Bilirubin-Total:</span><input type="text" name="Bilirubin_Total"></label>
					<label><span class="text-form">Bilirubin-Direct:</span><input type="text" name="Bilirubin_Direct"></label>
					<label><span class="text-form">Bilirubin-Indirect:</span><input type="text" name="Bilirubin_Indirect"></label>
					<label><span class="text-form">SGPT:</span><input type="text" name="SGPT"></label>
					<label><span class="text-form">SGOT:</span><input type="text" name="SGOT"></label>
					<label><span class="text-form">Serum Alkaline <br> Phosphatase:</span><input type="text" name="Phosphatase"></label>
					<u><h4>LIPID PROFILE</h4></u>
					<label><span class="text-form">Serum Cholesterol:</span><input type="text" name="Cholesterol"></label>
					<label><span class="text-form">Serum Triglyceride:</span><input type="text" name="Triglyceride"></label>
					<label><span class="text-form">HDL Cholesterol:</span><input type="text" name="HDL"></label>
					<label><span class="text-form">LDL Cholesterol:</span><input type="text" name="LDL"></label>
					<u><h4>RANDOM(RBS)</h4></u>
					<label><span class="text-form">Blood Glucose:</span><input type="text" name="Blood_Glucose"></label>
					...
					<label><span class="text-form">Serum Amylase:</span><input type="text" name="Amylase"></label>
				</div>
				<div class="grid_8">
					<label><span class="text-form"></span></label>
					<label><span class="text-form">Serum Acid<br>Phosphate:</span><input type="text" name="Phosphate"></label>
					<label><span class="text-form">Prostatc Fraction:</span><input type="text" name="Fraction"></label>
					<label><span class="text-form">Serum Lithium:</span><input type="text" name="Lithium"></label>
					<label><span class="text-form">Serum <br>Cholinesterase:</span><input type="text" name="Cholinesterase"></label>
					<label><span class="text-form">Serum Lipase:</span><input type="text" name="Lipase"></label>
					<label><span class="text-form">Magnesium:</span><input type="text" name="Magnesium"></label>
					<label><span class="text-form">Bicarbonate<br>(HCO3-):</span><input type="text" name="Bicarbonate"></label>
					<label><span class="text-form">Serum Acetone:</span><input type="text" name="Acetone"></label>
					<label><span class="text-form">GGTP:</span><input type="text" name="GGTP"></label>
				</div>
