...
<div class="bg-main">
    ...
    <a class="btn">Send</a>
		...
		-->
			...
			<form id="form1" action="mantoux_test2.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_24">
					<label><span class="text-form">Test was Read on:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="date" value="<?php echo date('Y-m-d'); ?>" name="read_on"></label>
					<label><span class="text-form">Test was Read After:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<div class="wrapper"><input type="radio" name="read_after" value="48"><div class="text-form2 fleft">48</div></div>
						<div class="wrapper"><input type="radio" name="read_after" value="72"><div class="text-form2 fleft">72</div></div>
					</label>
					<label><span class="text-form">Result:</span>
						<div class="wrapper pad-form"><input type="radio" name="result" value="0"><div class="text-form2 fleft">Negative</div></div>
						<div class="wrapper"><input type="radio" name="result" value="1"><div class="text-form2 fleft">Positive</div></div>
					</label>
					<label><span class="text-form">Induration:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" VALUE="NIL" name="Induration"></label>
					<label><span class="text-form">Erythemia:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" VALUE="NIL" name="Erythemia"></label>
					<label><span class="text-form">Necrosis:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" VALUE="NIL" name="Necrosis"></label>
				</div>
