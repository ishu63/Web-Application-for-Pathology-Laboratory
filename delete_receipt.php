...
<div class="bg-main">
	...
	<section class="padsection">
		<div class="container_24">
			<center><h1>DELET TEST</h1></center>
			<div class="clear"></div>
			<form id="form1" action="delete_receipt1.php" method="post">
				<div class="grid_24">
					...
					<center><div class="btns"><a class="btn" onClick="document.getElementById('form1').submit()">DELETE</a></div></center>
				</div>
				<div class="clear"></div>
			</form>
			<div class="clear"></div>
