...
<div class="bg-main">
	...
	<section class="padsection">
		<div class="container_24">
			...
			<div class="clear"></div>
			<hr><hr><hr>
			<form id="form1" action="thyroid_test2.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_12">
				...
				<div class="grid_12">
					...
					<label><span class="text-form"></span><input type="text" name="T3"></label>
					<label><span class="text-form"></span><input type="text" name="T4"></label>
					<label><span class="text-form"></span><input type="text" name="TSH"></label>
					<label><span class="text-form"></span><input type="text" name="FT3"></label>
					<label><span class="text-form"></span><input type="text" name="FT4"></label>
					<label><span class="text-form"></span><input type="text" name="PTH"></label>
				</div>
				<div class="grid_12">
				</div>
