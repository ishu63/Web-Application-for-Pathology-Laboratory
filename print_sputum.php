...
if(isset($_GET['show']))
{
	...
	$sql2="SELECT * FROM sputum WHERE P_ID = '$row1[0]'";
...
<div class="bg-main"  style="font-size:18px;line-height: 1.4;">
	...
	<section class="padsection">
		<div class="container_24">
			...
			<hr>
			<!--main data-->
			<center><h3><u>SPUTUM EXAMINATION</u></h3></center>
			<div class="grid_10">
				<ul>
					<li><u>TEST</u></li>
					<br>
					...
					<li>Consistency</li>
					<li><b><u>DIRECT MICROSCOPIC EXAMINATION / hpf</u></b></li>
					<li>Crystals</li>
					<li>Pus Cells / hpf</li>
					<li>Red Cells</li>
					<li>Epithelial Cells</li>
					<li><b><u>BACTERIOLOGICAL EXAMINATION</u></b></li>
					<li>Gram's Stain</li>
					<li>Z & N Stain</li>
					<li><b><u>GRAM STAIN PREPARATION</u></b></li>
					<li>Average Pus Cells</li>
					<li>Gram Positive Cocci</li>
			...
			<div class="grid_6" style="text-transform: uppercase;">
				<ul>
					...
					<li><br></li>
					<li><?php if($row2[2]==0){echo 'ABSENT';}else{echo '<b><u>PRESENT</u></b>';}?></li>
					<li><?php if($row2[3]==0){echo 'ABSENT';}else{echo '<b><u>OCCASIONAL</u></b>';}?></li>
					<li><?php if($row2[4]==0){echo 'ABSENT';}else{echo '<b><u>OCCASIONAL</u></b>';}?></li>
					<li><?php if($row2[5]==0){echo 'ABSENT';}else{echo '<b><u>OCCASIONAL</u></b>';}?></li>
					<li><br></li>
