...
<div class="bg-main">
	...
	<section class="padsection">
		<div class="container_24">
			...
			<div class="grid_24">
				<table align="center" >
					<tr>
						...
						<th width="300"><center>Doctor's Short Name</center></th>
						<th width="500"><center>Doctor's Full Name</center></th>
					</tr>
					<?php
						$rr=0;
						include('connect.php');
			...
			<center>
				<div class="btns">
					<a class="btn" onClick="window.location='insert_doctor.html';">ADD</a>
					<a class="btn" onClick="window.location='edit_doctor.html';">EDIT</a>
					<a class="btn" onClick="window.location='delete_doctor.html';">DELETE</a>
				</div>
			</center>
			<div class="clear"></div>
			<div class="wrapper">
