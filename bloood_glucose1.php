...
<div class="bg-main">
    ...
    <a class="btn">Send</a>
		...
		-->
			...
			<form id="form1" action="bloood_glucose2.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_24">
					<label><span class="text-form">Fasting Blood Glucose:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" name="fbg"></label>
					...
					<label><span class="text-form">Post Prandial Blood Glucose:</span><input type="text" name="ppbg"></label>
