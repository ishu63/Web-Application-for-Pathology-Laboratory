...
$sql1="SELECT * FROM liver_function_test WHERE P_ID = '$row[0]'";
...
<div class="bg-main">
    ...
    <a class="btn">Send</a>
		...
		-->
			<center><h1>Liver Function Test</h1></center>
			<form id="form2">
				<div class="grid_8">
			...
			<form id="form1"  action="edit_liver_function_test1.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_12">
					<?php
						$sql1="SELECT * FROM liver_function_test WHERE P_ID = '$row[0]'";
						$result1=mysql_query($sql1) or die('mysql error');
					...
					<label><span class="text-form">Bilirubin-Total:</span><input type="text" name="Bilirubin_Total" value="<?php echo $row1[1];?>"></label>
					<label><span class="text-form">Bilirubin-Direct:</span><input type="text" name="Bilirubin_Direct" value="<?php echo $row1[2];?>"></label>
					<label><span class="text-form">Bilirubin-Indirect:</span><input type="text" name="Bilirubin_Indirect" value="<?php echo $row1[3];?>"></label>
					<label><span class="text-form">SGPT:</span><input type="text" name="SGPT" value="<?php echo $row1[4];?>"></label>
					<label><span class="text-form">SGOT:</span><input type="text" name="SGOT" value="<?php echo $row1[5];?>"></label>
					<label><span class="text-form">Serum Alkaline <br> Phosphatase:</span><input type="text" name="Phosphatase" value="<?php echo $row1[6];?>"></label>
				</div>
				<div class="grid_12">
					<u><h4>PROTHROMBIN TIME</h4></u>
					<label><span class="text-form">Patient's P.T.:</span><input type="text" name="Patient_PT" value="<?php echo $row1[7];?>"></label>
					<label><span class="text-form">Control's P.T.:</span><input type="text" name="Control_PT" value="<?php echo $row1[8];?>"></label>
					<label><span class="text-form">ISI:</span><input type="text" name="ISI" value="<?php echo $row1[9];?>"></label>
					<label><span class="text-form">P. Index:</span><input type="text" name="Index" value="<?php echo $row1[10];?>"></label>
					<label><span class="text-form">P. Ratio:</span><input type="text" name="Ratio" value="<?php echo $row1[10];?>"></label>
					<label><span class="text-form">INR:</span><input type="text" name="INR" value="<?php echo $row1[12];?>"></label>
