...
$sql1="SELECT * FROM bloood_glucose WHERE P_ID = '$row[0]'";
...
<div class="bg-main">
	...
	<section class="padsection">
		<div class="container_24">
			<center><h1>Blood Glucose Report</h1></center>
			<form id="form2">
				<div class="grid_8">
			...
			<form id="form1" action="edit_bloood_glucose1.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_24">
					<?php
						$sql1="SELECT * FROM bloood_glucose WHERE P_ID = '$row[0]'";
						$result1=mysql_query($sql1) or die('mysql error');
					...
					?>
					<label><span class="text-form">Fasting Blood Glucose:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="text" name="fbg" value="<?php echo $row1[1];?>"></label>
					<label><span class="text-form">Fasting Urine Glucose:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<select name="fug">
							<option <?php if($row1[2]=="ABSENT"){echo "selected";}?>>ABSENT</option>
							<option <?php if($row1[2]=="TRACE"){echo "selected";}?>>TRACE</option>
							<option <?php if($row1[2]=="PRESENT(+)"){echo "selected";}?>>PRESENT(+)</option>
							<option <?php if($row1[2]=="PRESENT(++)"){echo "selected";}?>>PRESENT(++)</option>
							<option <?php if($row1[2]=="PRESENT(+++)"){echo "selected";}?>>PRESENT(+++)</option>
							<option <?php if($row1[2]=="PRESENT(++++)"){echo "selected";}?>>PRESENT(++++)</option>
						</select>
					</label>
					<label><span class="text-form">Fasting Urine Acetone:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<select name="fua">
							<option <?php if($row1[3]=="ABSENT"){echo "selected";}?>>ABSENT</option>
							<option <?php if($row1[3]=="TRACE"){echo "selected";}?>>TRACE</option>
							<option <?php if($row1[3]=="PRESENT(+)"){echo "selected";}?>>PRESENT(+)</option>
							<option <?php if($row1[3]=="PRESENT(++)"){echo "selected";}?>>PRESENT(++)</option>
							<option <?php if($row1[3]=="PRESENT(+++)"){echo "selected";}?>>PRESENT(+++)</option>
							<option <?php if($row1[3]=="PRESENT(++++)"){echo "selected";}?>>PRESENT(++++)</option>
						</select>
					</label>
					<label><span class="text-form">Post Prandial Blood Glucose:</span><input type="text" name="ppbg" value="<?php echo $row1[4];?>"></label>
					<label><span class="text-form">Post Prandial Urine Glucose:</span>
						<select name="ppug">
							<option <?php if($row1[5]=="ABSENT"){echo "selected";}?>>ABSENT</option>
							<option <?php if($row1[5]=="TRACE"){echo "selected";}?>>TRACE</option>
							<option <?php if($row1[5]=="PRESENT(+)"){echo "selected";}?>>PRESENT(+)</option>
							<option <?php if($row1[5]=="PRESENT(++)"){echo "selected";}?>>PRESENT(++)</option>
							<option <?php if($row1[5]=="PRESENT(+++)"){echo "selected";}?>>PRESENT(+++)</option>
							<option <?php if($row1[5]=="PRESENT(++++)"){echo "selected";}?>>PRESENT(++++)</option>
						</select>
					</label>
					<label><span class="text-form">Post Prandial Urine Acetone:</span>
						<select name="ppua">
							<option <?php if($row1[6]=="ABSENT"){echo "selected";}?>>ABSENT</option>
							<option <?php if($row1[6]=="TRACE"){echo "selected";}?>>TRACE</option>
							<option <?php if($row1[6]=="PRESENT(+)"){echo "selected";}?>>PRESENT(+)</option>
							<option <?php if($row1[6]=="PRESENT(++)"){echo "selected";}?>>PRESENT(++)</option>
							<option <?php if($row1[6]=="PRESENT(+++)"){echo "selected";}?>>PRESENT(+++)</option>
							<option <?php if($row1[6]=="PRESENT(++++)"){echo "selected";}?>>PRESENT(++++)</option>
						</select>
