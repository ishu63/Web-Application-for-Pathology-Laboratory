...
<div class="bg-main">
    ...
    <a class="btn">Send</a>
		...
		-->
			...
			<form id="form1" action="antenatal_profile2.php?P_ID=<?php echo $row[0];?>" method="post">
				<div class="grid_8">
					...
					<label><span class="text-form">Result:</span>
						<div class="wrapper"><input type="radio" name="vdrl" value="1"><div class="text-form2 fleft">REACTIVE</div></div>
						<div class="wrapper"><input type="radio" name="vdrl" value="0" checked><div class="text-form2 fleft">NON REACTIVE</div></div>
					</label>
				...
				<div class="grid_8">
					...
					<label><span class="text-form">Sample:</span>
						...
						<div class="wrapper"><input type="radio" name="sample" value="1" ><div class="text-form2 fleft">P.P.</div></div>
						<div class="wrapper"><input type="radio" name="sample" value="2" ><div class="text-form2 fleft">FASTING</div></div>
					</label>
					...
					<label><span class="text-form">Urine Sugar:</span>
						<div class="wrapper pad-form"><input type="radio" name="urin_sugar" value="0" checked><div class="text-form2 fleft">ABSENT</div></div>
						<div class="wrapper"><input type="radio" name="urin_sugar" value="1"><div class="text-form2 fleft">PRESENT</div></div>
					</label>
					<label><span class="text-form">Urine Acetone:</span>
						<div class="wrapper pad-form"><input type="radio" name="urin_Acetone" value="0" checked><div class="text-form2 fleft">ABSENT</div></div>
						<div class="wrapper"><input type="radio" name="urin_Acetone" value="1"><div class="text-form2 fleft">PRESENT</div></div>
					</label>
				</div>
				<div class="grid_8">
					<u><h4>AUSTRALIA ANTIGEN TEST (HBsAg)</h4></u>
					<label><span class="text-form">Result:</span>
						<div class="wrapper"><input type="radio" name="hbsag" value="1"><div class="text-form2 fleft">POSITIVE</div></div>
						<div class="wrapper"><input type="radio" name="hbsag" value="0" checked><div class="text-form2 fleft">NEGATIVE</div></div>
						</label>
					...
					<label><span class="text-form">Result:</span>
						<div class="wrapper"><input type="radio" name="shiv" value="1"><div class="text-form2 fleft">POSITIVE</div></div>
						<div class="wrapper"><input type="radio" name="shiv" value="0" checked><div class="text-form2 fleft">NEGATIVE</div></div>
						</label>
